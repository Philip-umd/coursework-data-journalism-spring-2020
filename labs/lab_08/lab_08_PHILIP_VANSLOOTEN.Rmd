...
#2. Using read_csv() to store file as a new object called average_county_pills_per_year

average_county_pills_per_year <- read_csv(average_county_pills_per_year_url)
...
state_population_white_only_2014 <- get_acs(geography = "state", 
