...
#Install Tidyverse suite, Janitor (data cleaning) and Lubridate (working with dates as data)
...
# Observations (rows): 37,154; Variables (columns): 42
...
#create a table that answers the following question: how many total pills were shipped to Mingo County each year between 2006 and 2012?

# group into a pivot table (group by transaction_year) AND
# summarize by a total_pills column with sum totals of dosage_units (pills) AND
# arrange transaction years in increasing order
...
#The amounts increased until 2008 and then decreased, with the largest decrease after 2009.
